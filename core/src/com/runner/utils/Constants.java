...
public class Constants {
    ...
    public static final float RUNNER_SPEED_STEP = 5f;   //THe amount the players speed increases per button click
    ...
    public static final String UI_ATLAS_PATH = "ui/atlas.txt";
    public static final String UI_SKIN_PATH = "ui/skin.json";
