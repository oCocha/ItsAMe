package com.runner.multiplayer;
...
public class WarpController {
	...
	private final String apiKey = "601bc8eba22e6f40089f50f3ede9bd656e8851b3a1c22f0b39152f3f7fd911bc";
	private final String secretKey = "4e14253134b3811944252dc0b154061b9c1ef726d403d9d6a15aafc457ea1f33";
	...
	public void startApp(String localUser){
        ...
        System.out.println("3: connect with: "+localUser+" --- ");
	}
	...
	private void initAppwarp(){
		try {
			...
			System.out.println("1: WarpClient initialized --- ");
			warpClient = WarpClient.getInstance();
            System.out.println("2: warpClient --- ");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
